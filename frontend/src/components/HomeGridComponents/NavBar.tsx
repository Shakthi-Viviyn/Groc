...
import GazePricesView from "../ModalContentComponents/GazePricesView";
...
function NavBar() {
  ...
  function handleGazePrices(){
    setShowModal(true);
    setModalContent(<GazePricesView />);
  }
  ...
  return (
    <div className="navbar flex justify-between items-center px-6 w-full bg-slate-200 rounded-lg shadow-lg font-mono">
      ...
      <div className="flex gap-5 h-full">
        <button className="bg-slate-300 py-1 px-4 hover-effect text-lg" onClick={handleGazePrices}>Gaze Prices</button>
